    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 container max-w-4xl mx-auto px-4 py-8">
        <div className="space-y-8">
          <div className="text-center space-y-4">            <Avatar className="w-24 h-24 mx-auto">
          ...
          </div>          <div className="w-full space-y-6">            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Clock className="h-5 w-5" />
                  Last Analysis
                </CardTitle>
                <CardDescription>Your most recent analysis result</CardDescription>
              </CardHeader>
                <CardContent>
                  {!lastAnalysis ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6">
                        You haven't performed any analysis yet. Start by taking an analysis!
                      </p>
                      <Link to="/analysis">
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <Button 
                          ...
                          className="text-rose-600 border-rose-600 hover:bg-rose-400"
                        >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div className="text-center p-4 bg-rose-50 rounded-lg">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            <span className="capitalize text-lg">{lastAnalysis.faceShape}</span>
                        ...
                        <div className="text-center p-4 bg-amber-50 rounded-lg">
                          ...
                          <span className="capitalize text-lg">{lastAnalysis.skinTone}</span>
                        </div>
                        <div className="text-center p-4 bg-green-50 rounded-lg">
                          <h4 className="font-medium mb-2">Color Groups</h4>
                          <span className="text-lg">{lastAnalysis.colorGroups?.length || 0} groups</span>
                        </div>
                      </div>

                      {lastAnalysis.recommendations && lastAnalysis.recommendations.length > 0 && (
                        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                          <h4 className="font-medium mb-3">Recommended Tutorial Videos</h4>
