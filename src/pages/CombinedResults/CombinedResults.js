  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 container max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8">
        <Link
          to="/analysis"
          className="inline-flex items-center gap-2 text-rose-400 mb-4 lg:mb-6 hover:text-rose-500 transition-colors text-sm"
        >
        ...
        <div className="space-y-6 lg:space-y-8">
          <div className="text-center space-y-2 lg:space-y-4">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base">
              Your personalized face shape and skin tone analysis with curated
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 lg:items-start">
            ...
            <Card className="flex flex-col h-full min-h-[300px] sm:min-h-[350px] lg:min-h-[400px] border-2 border-rose-200 bg-rose-50/50">
              <CardHeader className="pb-2 lg:pb-3 flex-shrink-0">
                ...
                <CardDescription className="text-xs sm:text-sm">
                  Your predicted face shape and skin tone
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-1 flex flex-col justify-center space-y-4 sm:space-y-6 lg:space-y-8 px-3 sm:px-6 pb-4 lg:pb-6">
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-rose-500 flex items-center justify-center text-white text-lg sm:text-xl lg:text-2xl font-bold mx-auto mb-3">
                    {faceShapeData.result.predicted_face_shape
                      .charAt(0)
                      .toUpperCase()}
                  </div>
                  ...
                  <p className="text-rose-600 font-medium text-sm sm:text-base lg:text-lg mt-2">
                    Confidence:{" "}
                    {(faceShapeData.result.confidence * 100).toFixed(2)}%
                  </p>
                </div>
                <div className="text-center">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-sm lg:text-base">
                Complete breakdown of face shape probabilities and skin tone
                analysis
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="face-shape" className="w-full">
                <TabsList className="grid w-full grid-cols-2 h-9 lg:h-10">
                  ...
                  <TabsTrigger value="skin-tone" className="text-xs lg:text-sm">
                    Skin Tone Analysis
                  </TabsTrigger>
                </TabsList>
                ...
                >
                  <h4 className="font-medium mb-3 lg:mb-4 text-sm lg:text-base">
                    Face Shape Probability Distribution
                  </h4>
                ...
                >
                  <h4 className="font-medium mb-3 lg:mb-4 text-sm lg:text-base">
                    Skin Tone: {skinToneData.skin_tone.toUpperCase()}
                  </h4>
                  <p className="text-gray-600 mb-4 text-sm lg:text-base">
                    Based on your skin tone analysis, you have been classified
                    as having a <strong>{skinToneData.skin_tone}</strong>{" "}
                    complexion. This means certain color palettes will be more
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {skinToneData.recommended_groups.map((group, index) => (
                      ...
                      >
                        <h5 className="font-medium mb-2 text-sm lg:text-base">
                          {getGroupDisplayName(group.group)}
                        </h5>
                        <p className="text-xs lg:text-sm text-gray-600 mb-3">
                          {group.colors.length} recommended colors
                        </p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-sm lg:text-base">
                Colors organized by seasonal groups, perfectly matched to your{" "}
                {skinToneData.skin_tone} skin tone
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6 lg:space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-sm lg:text-base">
                {faceShapeData.result.hijabRecomendation.total_recommendations}{" "}
                curated video tutorials perfect for your{" "}
                {faceShapeData.result.hijabRecomendation.face_shape.toLowerCase()}{" "}
                face shape
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
                {faceShapeData.result.hijabRecomendation.recommendations.map(
                  (url, index) => (
                    <div
                      key={index}
          ...
          <div className="p-3 sm:p-4">
            ...
            <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Perfect for your {faceShapeData.result.predicted_face_shape}{" "}
                face shape
              </p>
              <a
                href={selectedVideo}
